...
# A primeira forma de implementar a minha ideia.
while (True):
    a = int(input("\n Digite um número da loteria de 1 a 100:  \n"))

    if a > 0: print("\nDigite um número entre 0 a 100, lembra das regras?")
...
# Uma segunda forma de implementar a mesma ideia.
numero_secreto = 47
